  ...
  <c:if test="${not empty items}">
    <div id="atg_store_prodList">
      ...
      <ul class="atg_store_product">
        ...
        <c:forEach items="${items}" var="productItem" begin="1" end="${count}">  
          <li>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.0/Storefront/j2ee/store.war/cartridges/ProductSpotlight-ATGTargeter/ProductSpotlight-ATGTargeter.jsp#1 $$Change: 848678 $ --%>